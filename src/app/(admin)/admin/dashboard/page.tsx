...
import { Users, Clock, CheckCircle, AlertCircle, TrendingUp, ArrowUpRight, ShieldCheck } from "lucide-react";
...
export default function AdminDashboard() {
  const stats = [
    ...
    { label: "Approved Support", value: "890", icon: CheckCircle, color: "text-emerald-600", bg: "bg-emerald-50" },
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {stats.map((stat, i) => (
          ...
          >
            ...
            <h3 className="text-4xl font-black text-brand-slate mt-2 relative z-10">{stat.value}</h3>
              ...
              {[
                ...
                <tr key={i} className="hover:bg-slate-50/80 transition-colors group">
                  ...
                  <td className="px-10 py-6 text-right">
                    <button className="h-9 w-9 rounded-xl bg-slate-100 text-slate-400 flex items-center justify-center group-hover:bg-brand-blue group-hover:text-white transition-all shadow-sm">

 ...
 * NotificationContext
 *
 * Provides a shared unread count and a `refresh()` call across the student
 * portal so that the nav badge and the notifications page stay in sync.
 *
 * The context lives in the student layout, the nav reads from it, and the
 * notifications page calls refresh() after any mutation.
 */
